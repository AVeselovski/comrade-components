    ...
    <Page bg="bg" py={5} pt={120}>
      <Container px={[3, 4]}>
        <div className="mb-4">
          ...
          <br />
          <h5 className="heading-5 success mb-1">Success heading 5</h5>
          <h5 className="warning mb-1">Warning heading 5</h5>
          <h6 className="heading-6 danger mb-1">Danger heading 6</h6>
          <h6 className="info mb-1">Info heading 6</h6>
        </div>
        <div className="mb-4">
