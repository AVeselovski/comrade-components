...
<Text as="span" color="secondary" size="md">Big chunky text as &lt;span&gt; element</Text>
<br />
<Text as="span" color="danger" size="sm">
  Small "danger" text as &lt;span&gt; element
</Text>

<ul>
  <Text as="li" color="info">This is a colored list item</Text>
  <Text as="li" color="success">This is a colored list item</Text>
